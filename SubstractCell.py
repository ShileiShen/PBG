...
filepath = 'C:\A_MYKHAILO\simulations\Pattern\EBL designes\PBG\PGB_meander\L3000um_8cells_22_132Ohms'
...
l_res=996   #length of lambda/2 resonator at 7.3 GHz
t_res=2+2*123 #width of the resonator

gap_Zlow=4 #gap between the Zlow and the ground plane
gap_Zhigh=123 #gap between the Zhigh and the ground plane
...
gnd=gdspy.Rectangle( ( 0,-4208) , ( 9836, 750 ) )
cell_gnd.add(gnd)
